...
DEVICE = select_device(debug=True)  # torch.device('cpu')  # select_device()
...
# build the model
model, loss_fn, optimizer = model.build_model_simple(
    IMAGE_WIDTH, IMAGE_HEIGHT, NUM_CHANNELS, NUM_CLASSES, LR, L2_REG
)
