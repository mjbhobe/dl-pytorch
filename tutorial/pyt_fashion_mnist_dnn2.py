...
Part-2 of the tutorial for torch training toolkit, where we add custom metrics that are
tracked at epoch level during training.

Step02 - tracking additional metrics during training/evaluation
